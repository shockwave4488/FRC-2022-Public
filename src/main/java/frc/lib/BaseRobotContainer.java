...
public abstract class BaseRobotContainer implements IRobotContainer {
   ...
   * edu.wpi.first.wpilibj.Joystick} or {@link XboxController}), and then passing a BooleanSupplier
   * of the button state to a {@link edu.wpi.first.wpilibj2.command.button.Trigger}.
   */
