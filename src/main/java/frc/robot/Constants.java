...
public final class Constants {
  ...
  public static final class MockBuildWeek2023Constants {
    ...
    public static final List<Integer> stationTagIds =
        Collections.unmodifiableList(List.of(2, 6, 12, 20)); // left to right station order
    public static final Map<Integer, Integer> cubeIdToStationId =
        Collections.unmodifiableMap(Map.of(5, 2, 29, 6, 26, 12, 7, 20));
